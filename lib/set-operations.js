...
/**
Modifies setA to contain only elements that are present in setA and not in setB.
@param {Object} setA
@param {Object|Array} setB
@api public
**/
...
Set.addSet = addSet;
Set.remove = remove;
Set.removeSet = removeSet;
Set.symmetricRemoveSet = symmetricRemoveSet;
Set.toArray = toArray;
Set.clear = clear;
Set.size = size;
...
Set.isSupersetOf = isSupersetOf;
Set.isProperSupersetOf = isProperSupersetOf;
